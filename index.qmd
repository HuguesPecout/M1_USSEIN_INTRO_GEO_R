...
subtitle: "Séminaire TAIS (EHESS), 23 mai 2024"
author: "Hugues Pecout & Timothée Giraud"
institute: UMR Géographie-Cités & UAR RIATE 
img : img/cnrs.png
title-slide-attributes:
  data-background-image: img/ehess.png
  data-background-size: 5%
  data-background-position: 2% 2%
footer: "Séminaire TAIS - EHESS, 23 mai 2024"
...
Ingénieur en science de l'information géographique au CNRS depuis 2012

A l'UMR Géographie-cités depusi 2022. Aide les chercheurs en Géographie pour le traitement de l'information géographique

Tout types de données

Formation Géomatique classique. Utilisation d'outils SIG clic boutton

Spécialisation dans l'utilisation de R 
...
```{r warning=FALSE, message=FALSE, eval=TRUE, include= TRUE, echo=FALSE, fig.width=20, fig.height=10}
...
C'est une **image matricielle localisée dans l'espace**.

L'information géographique est alors stockée dans des pixels.

Chaque pixel, **défini par une résolution**, possède des valeurs qui
peuvent être traitées et cartographiées.
:::
...
Il s'agit d'objets géométriques de type **points**, **lignes** ou
**polygones**.
...
:::{.bigquat}
<center>
[Algèbre spatiale avec `Terra` &rarr; [Géomatique avec R](https://rcarto.github.io/geomatique_avec_r/09_package_terra.html)]{.bigbis}
</center>
:::
...
<center>
**Objet `sf` &rarr; objet `SpatVector`**
</center>
...
<center>
**Objet `SpatVector` &rarr; objet `sf`**
</center>
...
<center>
**&rarr;** [**Site Web**](https://riatelab.github.io/mapsf/)
</center>
:::
...
<center>
![[Download CheatSheet](https://raw.githubusercontent.com/riatelab/mapsf/master/vignettes/web_only/img/mapsf_cheatsheet.pdf)](img/mapsf_cheatsheet.png)
</center>
:::
...
<center>
[Manuel d'utilisation du package `mapsf` &rarr; [Cartographie avec R](https://rcarto.github.io/geomatique_avec_r/09_package_terra.html)]{.bigbis}
</center>
...
<center>
Liste des couleurs implementées : [**http://www.stat.columbia.edu/~tzheng/files/Rcolor.pdf**](http://www.stat.columbia.edu/~tzheng/files/Rcolor.pdf)
...
[https://github.com/rspatial/geodata](https://github.com/rspatial/geodata)   
...
{{< fa solid users >}} Robin Lovelace, Jakub Nowosad, Jannes Muenchow (2019)
...
{{< fa solid link >}} [https://rzine.fr/](https://rzine.fr/)
...
{{< fa solid link >}} [https://elementr.netlify.app/](https://elementr.netlify.app/)
...
:::{.center .bigbis2}
[**https://github.com/HuguesPecout/GeoExo_TAIS**](https://github.com/HuguesPecout/GeoExo_TAIS)

\

[![](img/project.png){width="20%"}]()

**Téléchargez ce** [**projet Rstudio**](https://github.com/HuguesPecout/GeoExo_TAIS/archive/refs/heads/main.zip)
:::   
...
{{< fa display >}} [Diaporama en ligne](https://tais-ehess-hpecout-bb467c23dd2ecba666035579bc786d99e7bb2c2b3553.gitpages.huma-num.fr/#/title-slide)

\

{{< fa code >}} [Code source](https://gitlab.huma-num.fr/hpecout/tais_ehess)
...
<img src="img/geographie.png" width="80" style="margin-right:50px"/><img src="img/cnrs.png" width="80" style="margin-right:50px"/><img src="img/riate.png" width="150"/>
:::
