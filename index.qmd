...
{{< fa solid link >}} [**Liste de ressources**](https://rzine.gitpages.huma-num.fr/site/ressources/)
...
**Téléchargez ce** [**projet Rstudio**](https://github.com/HuguesPecout/DEMO_GEO_R/archive/refs/heads/main.zip)
:::   
...
{{< fa display >}} [Diaporama en ligne](https://huguespecout.github.io/M1_USSEIN_INTRO_GEO_R)

\

{{< fa code >}} [Code source](https://github.com/HuguesPecout/M1_USSEIN_INTRO_GEO_R)
